...
mysql_query("update souvenir set hit=$hit where id=$id",$con);
...
echo("					
			...
			<div class='btn_area justify'> 
				<div class='left'>
					<a class='btns board_white' href='svpass.php?board=souvenir&id=$id&mode=0'>수정</a>
					<a class='btns board_white' href='svpass.php?board=souvenir&id=$id&mode=1'>삭제</a>
				</div> 
				<a class='btns board_white' href='svreply.php?board=souvenir&id=$id'>답글쓰기</a>
				<a class='btns board gray' href='svinput.php?board=souvenir'>글쓰기</a>
				<a class='btns board_white _article-list' href='svshow.php?board=souvenir'>목록</a>
			</div> 
			<div class='tbl_other'> 
				<ul> 
					<li class='pre'> 
