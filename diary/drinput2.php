...
echo("<html>
		...
		<body onmouseover='dday()' onchange='dday()'>
		 <div class='content_tit_area clfix first_child no_line'>
			<h2 class='content_tit'>다이어리 경로 쓰기</h2>
		 </div>
		 <div class='wrap_tbl_write tb_write'>
			<form method='post' action='drprocess2.php?dname=$dname' class='_article-form'>
			<table>
				<caption>
				...
				<tbody>
					...
					<tr>
						<th scope='row'>경로</th>
						<td>
							<textarea name='route' class='ipt_txt _article-title' style='width: 684px;' vlaue='→'></textarea>
						</td>
					</tr>
				</tbody>
			</table>
