...
$maint = mysql_query("select * from place where id=$id", $con);
if(!$userfile) {
...
// 변경 내용을 테이블에 저장함
$result = mysql_query("update place set writer='$writer', topic='$topic', content='$content', hit=$hit, wdate='$wdate', filename='$userfile_name', filesize='$userfile_size', space=$space where id=$id", $con);
}
mysql_close($con);
