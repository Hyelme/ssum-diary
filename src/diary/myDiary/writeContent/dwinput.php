...
echo("<html>
		...
		<body onmouseover='dday()' onchange='dday()'>
		 <div class='content_tit_area clfix first_child no_line'>
			<h2 class='content_tit'>다이어리 글 쓰기</h2>
		 </div>
		 <div class='wrap_tbl_write tb_write'>
			<form method='post' action='dwprocess.php?dname=$dname' class='_article-form'>
			<table>
				<caption>
				...
				<tbody>
					...
					<tr>
						<td colspan=2>
							...
							<textarea name='content' class='_editor-required _article-content' style='height: 500px; ' data-required='내용을 입력해주세요.'></textarea>
						</td>
					</tr>
				</tbody>
			</table>
