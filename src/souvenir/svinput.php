...
<title>기념품 공유 게시판 입력 폼</title>
 ...
 <h2 class='content_tit'>기념품 공유 게시판</h2>
  ...
  <div class='wrap_tbl_write tb_write'>
	<form class='_article-form' method='post' action='svprocess.php?board=souvenire' enctype='multipart/form-data'>
		<table>
			<caption>
			기념품 공유 게시판 입력 폼 : 작성자, 제목, 내용
			</caption>
			<colgroup>
				<col style='width : 19%;' />
				<col style='width : 81%;' />
