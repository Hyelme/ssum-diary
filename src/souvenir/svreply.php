...
<HTML html>
<head>
<title>기념품 답글 입력 폼</title>
  <link href='../css/common.css' rel='stylesheet'>
  <link href='../css/rest.css' rel='stylesheet'>
 </head>
 <body>
 <div class='content_tit_area clfix first_child no_line'>
 <h2 class='content_tit'>기념품 답글 달기</h2>
 </div>
  <div class='wrap_tbl_write tb_write'>
	<form class='_article-form' method='post' action='svrprocess.php?board=souvenir&id=$id'>
		<table>
			<caption>
			기념품 답글 입력 폼 : 작성자, 제목, 내용
			</caption>
			<colgroup>
				<col style='width : 19%;' />
				<col style='width : 81%;' />
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<textarea name='content' class='_editor-required _article-content' style='height: 193px; ' data-required='내용을 입력해주세요.'>$pre_content</textarea>
					</td>
				</tr>
			</tbody>
		</table>
