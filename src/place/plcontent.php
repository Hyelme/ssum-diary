...
mysql_query("update place set hit=$hit where id=$id",$con);
...
echo("					
			...
			<div class='btn_area justify'> 
				<div class='left'>
					<a class='btns board_white' href='plpass.php?board=$board&id=$id&mode=0'>수정</a>
					<a class='btns board_white' href='plpass.php?board=$board&id=$id&mode=1'>삭제</a>
				</div> 
				<a class='btns board_white' href='plreply.php?board=$board&id=$id'>답글쓰기</a>
				<a class='btns board gray' href='plinput.php?board=$board'>글쓰기</a>
				<a class='btns board_white _article-list' href='plshow.php?board=place'>목록</a>
			</div> 
			<div class='tbl_other'> 
				<ul> 
					<li class='pre'> 
