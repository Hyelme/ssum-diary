...
<HTML html>
<head>
<title>여행지 입력 폼</title>
  <link href='../css/common.css' rel='stylesheet'>
  <link href='../css/rest.css' rel='stylesheet'>
 </head>
 <body>
 <div class='content_tit_area clfix first_child no_line'>
 <h2 class='content_tit'>여행지 답글 달기</h2>
 </div>
  <div class='wrap_tbl_write tb_write'>
	<form class='_article-form' method='post' action='plrprocess.php?board=place&id=$id'>
		<table>
			<caption>
			여행지 답글 입력 폼 : 작성자, 제목, 내용
			</caption>
			<colgroup>
				<col style='width : 19%;' />
				<col style='width : 81%;' />
