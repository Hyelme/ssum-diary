...
$result=mysql_query("select id from place",$con);
...
// 테이블에 입력 글 내용을 저장
mysql_query("insert into place(id, writer, topic, content, hit, wdate, filename, filesize, space) values($id, '$writer', '$topic', '$content', 0, '$wdate', '$userfile_name', '$userfile_size', 0)", $con);
...
echo("<meta http-equiv='Refresh' content='0; url=plshow.php?board=$board'>");
