...
$result=mysql_query("select id from notice",$con);
...
// 테이블에 입력 글 내용을 저장
mysql_query("insert into notice(id, writer, topic, content, hit, wdate, space) values($id, '$writer', '$topic', '$content', 0, '$wdate', 0)", $con);
